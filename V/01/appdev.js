! function(e) {
    ...
    d.Listeners.Basic = {
        openListener: function() {
            c((0, r.default)(this), "open")
        },
        closeListener: function() {
            (0, r.default)(this).data("close") ? c((0, r.default)(this), "close") : (0, r.default)(this).trigger("close.zf.trigger")
        },
        toggleListener: function() {
            (0, r.default)(this).data("toggle") ? c((0, r.default)(this), "toggle") : (0, r.default)(this).trigger("toggle.zf.trigger")
        },
        closeableListener: function(e) {
            e.stopPropagation();
            var t = (0, r.default)(this).data("closable");
            "" !== t ? a.Motion.animateOut((0, r.default)(this), t, (function() {
        ...
        closeMeListener: function(e, t) {
            ...
            (0, r.default)("[data-" + i + "]").not('[data-yeti-box="' + t + '"]').each((function() {
        ...
        if (e && ("string" == typeof e ? i.push(e) : "object" === (void 0 === e ? "undefined" : n(e)) && "string" == typeof e[0] ? i.concat(e) : console.error("Plugin names must be strings")), t.length) {
            var o = i.map((function(e) {
                return "closeme.zf." + e
            })).join(" ");
            (0, r.default)(window).off(o).on(o, d.Listeners.Global.closeMeListener)
        }
    ...
    var r, a, l, c, d, u, h, p, f, v, m, g, w, y, T, S, b, x = (r = animation_tl("1"), a = $("[data-for-people]"), l = $("[data-projects-slider]"), $("[data-founders-slider]"), c = $("[data-team-slider]"), d = $("[data-projects-close]"), u = $("[data-projects-wrap]"), h = $("[data-projects-list]"), p = $("[data-projects-list-mob]"), f = h.find("[data-projects-list-item]"), v = p.find("[data-projects-list-item]"), m = $("[data-project-slide]"), g = $("[data-projects-scroll-list]"), w = $("[data-projects-scroll-wrap]"), y = $("[data-news-slider]"), $("#team-inner"), T = function() {
            ...
            init: function() {
                $("[data-section]").each((function() {
                    ...
                    if ("team" == e.data("section")) return e.data("show", t.show), void e.data("hide", t.hide);
                    ...
                    menu: "#menu-main-menu",
                    navigation: !1,
                    anchors: ["home", "projects", "visions", "visions1", "visions2", "visions3", "news", "team"],
                    scrollingSpeed: 1500,
                    scrollOverflow: !0,
                    scrollOverflowReset: !1,
                    normalScrollElements: "#team-inner",
                    touchSensitivity: 15,
                    animateAnchor: !0,
                    ...
                    onLeave: function(e, t, i) {
                        ...
                        switch ("team" != t.anchor && (a[0].href = "#" + t.anchor, a.data("anchor", t.anchor)), n.hide.eventCallback("onComplete", null), n.hide.eventCallback("onReverseComplete", null), n.show.eventCallback("onComplete", null), n.show.eventCallback("onReverseComplete", null), o.hide.eventCallback("onComplete", null), o.hide.eventCallback("onReverseComplete", null), o.show.eventCallback("onComplete", null), o.show.eventCallback("onReverseComplete", null), i) {
                            case "down":
                        ...
                        var d = "team" != t.anchor;
                        switch (fullpage_api.setAllowScrolling(d), "team" == e.anchor && E.introTl.reverse(), t.anchor) {
                            case "home":
                            ...
                            case "visions":
                                ...
                                break;
                            case "visions1":
                                exciterDisable(), "down" == i ? r.tweenFromTo("1", "2") : r.tweenFromTo("3", "2");
                                break;
                            case "visions2":
                                exciterDisable(), "down" == i ? r.tweenFromTo("2", "3") : r.tweenFromTo("4", "3");
                                break;
                            case "visions3":
                                exciterDisable(), r.tweenFromTo("3", "4");
                                break;
                            case "team":
                                exciterDisable(), $("#team-inner")[0].scrollTop = 0, E.introTl.play(), 0 != E.tlFoundersReveal.progress() && (E.tlFoundersReveal.timeScale(20), E.tlFoundersReveal.reverse());
                                break;
                            default:
                                exciterDisable()
                        }
                        "team" == e.anchor && startShape()
                    }
                }), c.slick({
                    arrows: !0,
                    slidesToShow: 3,
        ...
        E = function() {
            var e = $("[data-for-people]"),
                ...
                o = ($("[data-founders-slider]"), $("[data-team-slider-section]"), $("[data-team-slider]")),
                s = !1,
                r = new ScrollMagic.Controller({
                    container: "#team-inner"
                }),
                a = ($("[data-founder-slide]"), $("#team-inner")),
            ...
            return {
                ...
                init: function() {
                    s || (s = !0, function() {
                        ...
                        var s = document.querySelector("#team-inner");
    ...
    ! function(e) {
        ...
        THREE.UnrealBloomPass = function(e, t, i, o) {
            THREE.Pass.call(this), this.strength = void 0 !== t ? t : 1, this.radius = i, this.threshold = o, this.resolution = void 0 !== e ? new THREE.Vector2(e.x, e.y) : new THREE.Vector2(256, 256), 
            ...
            this.oldClearAlpha = 1, this.basic = new THREE.MeshBasicMaterial, this.fsQuad = new THREE.Pass.FullScreenQuad(null)
        ...
        function K() {
            ...
            function() {
                (w = new THREE.PerspectiveCamera(45, 1, 1, -1e3)).position.set(0, 0, 250), y = new THREE.Scene, window.renderer = new THREE.WebGLRenderer({
                    antialias: !1,
                    depth: !1
                }), renderer.setSize(S, 500), renderer.autoClear = !1, renderer.setPixelRatio(2), renderer.gammaFactor = 2.2, document.getElementById("container").appendChild(renderer.domElement), window.composer = new THREE.EffectComposer(renderer), window.colorify = new THREE.ShaderPass(THREE.ColorShader),
                

                ////XXXXXX3
                colorify.uniforms.color.value = new THREE.Color('#050118');
