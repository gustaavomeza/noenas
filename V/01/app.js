    ...
    var r, a, l, c, d, u, h, p, f, v, m, g, w, y, T, S, b, x = (r = animation_tl("1"), a = $("[data-for-people]"), l = $("[data-projects-slider]"), $("[data-founders-slider]"), c = $("[data-contact-slider]"), d = $("[data-projects-close]"), u = $("[data-projects-wrap]"), h = $("[data-projects-list]"), p = $("[data-projects-list-mob]"), f = h.find("[data-projects-list-item]"), v = p.find("[data-projects-list-item]"), m = $("[data-project-slide]"), g = $("[data-projects-scroll-list]"), w = $("[data-projects-scroll-wrap]"), y = $("[data-news-slider]"), $("#contact-inner"), T = function() {
            ...
            init: function() {
                $("[data-section]").each((function() {
                    ...
                    if ("contact" == e.data("section")) return e.data("show", t.show), void e.data("hide", t.hide);
                    ...
                    normalScrollElements: "#contact-inner",
                    touchSensitivity: 15,
                    animateAnchor: !0,
                    ...
                    onLeave: function(e, t, i) {
                        ...
                        switch ("contact" != t.anchor && (a[0].href = "#" + t.anchor, a.data("anchor", t.anchor)), n.hide.eventCallback("onComplete", null), n.hide.eventCallback("onReverseComplete", null), n.show.eventCallback("onComplete", null), n.show.eventCallback("onReverseComplete", null), o.hide.eventCallback("onComplete", null), o.hide.eventCallback("onReverseComplete", null), o.show.eventCallback("onComplete", null), o.show.eventCallback("onReverseComplete", null), i) {
                            case "down":
                        ...
                        switch (fullpage_api.setAllowScrolling(d), "contact" == e.anchor && E.introTl.reverse(), t.anchor) {
                            ...
                            case "contact":
                                //exciterEnable(), r.tweenFromTo("1", "1");
                                exciterDisable(), $("#contact-inner")[0].scrollTop = 0, E.introTl.play(), 0 != E.tlFoundersReveal.progress() && (E.tlFoundersReveal.timeScale(20), E.tlFoundersReveal.reverse());
                                break;
                            default:
                                exciterDisable()
                        }
                        "contact" == e.anchor && startShape()
                    }
                }), c.slick({
                    arrows: !0,
                    slidesToShow: 3,
